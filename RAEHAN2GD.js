...
//////////////////////////////////     HANZ    ////////////////////////////////////
const fakeWaveform = new Uint8Array([10, 20, 100, 100, 80, 100, 90, 100, 70, 100, 200, 100, 60, 90, 70, 40, 20, 100, 40, 80, 100, 80, 40, 20]);
//////////////////////////////////     HANZ    ////////////////////////////////////
...
"ʟᴏᴀᴅɪɴɢ sᴜᴄᴄᴇssғᴜʟ . . ."
    ...
    await RAEHAN2GD.sendMessage(m.chat, {
        ...
        ptt: true,
        waveform: fakeWaveform // Menambahkan garis-garis VN
    });
}
...
break;
 ...
 case 'huh': {
await RAEHAN2GD.sendMessage(m.chat, {
    audio: { url: 'https://mp3tourl.com/audio/1785578982135-870814ad-d4b0-439b-98b3-353324684de5.opus' }, 
    mimetype: 'audio/ogg; codecs=opus',
    ptt: true,
    waveform: fakeWaveform, // Menambahkan garis-garis
     // Ganti dengan durasi asli audio (dalam detik), atau hapus baris ini agar otomatis
});}
			break;			
			
case 'vn?': {
await RAEHAN2GD.sendMessage(m.chat, {
    audio: { url: 'https://mp3tourl.com/audio/1785579015020-42cde0f6-6164-4ce5-831e-d8b7280dad82.opus' }, 
    mimetype: 'audio/ogg; codecs=opus',
    ptt: true,
    waveform: fakeWaveform, // Menambahkan garis-garis
     // Ganti dengan durasi asli audio (dalam detik), atau hapus baris ini agar otomatis
		...
		case 'gbisa': {
await RAEHAN2GD.sendMessage(m.chat, {
    audio: { url: 'https://mp3tourl.com/audio/1785579046115-12f585a9-cc20-4903-9a89-db7cbe957d26.opus'},
    mimetype: 'audio/ogg; codecs=opus',
    ptt: true,
    waveform: fakeWaveform, // Menambahkan garis-garis
     // Ganti dengan durasi asli audio (dalam detik), atau hapus baris ini agar otomatis
...
break
			...
			case 'ap': {
await RAEHAN2GD.sendMessage(m.chat, {
    audio: { url: 'https://mp3tourl.com/audio/1785579074796-28a23fcf-529b-474a-91d1-22b4c98507fe.opus' }, 
    mimetype: 'audio/ogg; codecs=opus',
    ptt: true,
    waveform: fakeWaveform, // Menambahkan garis-garis
     // Ganti dengan durasi asli audio (dalam detik), atau hapus baris ini agar otomatis
...
break
			...
			case 'y': {
await RAEHAN2GD.sendMessage(m.chat, {
    audio: { url: 'https://mp3tourl.com/audio/1785579446282-482de65c-b49c-4136-848f-11ebe3715393.opus' }, 
    mimetype: 'audio/ogg; codecs=opus',
    ptt: true,
    waveform: fakeWaveform, // Menambahkan garis-garis
     // Ganti dengan durasi asli audio (dalam detik), atau hapus baris ini agar otomatis
...
case 'hhh': {
await RAEHAN2GD.sendMessage(m.chat, {
    audio: { url: 'https://mp3tourl.com/audio/1785579517622-1f30b4cc-7d60-4815-938e-8492b8f40d59.opus' }, 
    mimetype: 'audio/ogg; codecs=opus',
    ptt: true,
    waveform: fakeWaveform, // Menambahkan garis-garis
     // Ganti dengan durasi asli audio (dalam detik), atau hapus baris ini agar otomatis
...
case 'wow': {
await RAEHAN2GD.sendMessage(m.chat, {
    audio: { url: 'https://mp3tourl.com/audio/1785579553822-e5b836e0-34be-4781-ad9a-e33c08af3047.opus' }, 
    mimetype: 'audio/ogg; codecs=opus',
    ptt: true,
    waveform: fakeWaveform, // Menambahkan garis-garis
     // Ganti dengan durasi asli audio (dalam detik), atau hapus baris ini agar otomatis
...
case 'lama': {
await RAEHAN2GD.sendMessage(m.chat, {
    audio: { url: 'https://mp3tourl.com/audio/1785579582522-9045c0bc-b4c8-4666-8ef6-6962bf65efbb.opus' }, 
    mimetype: 'audio/ogg; codecs=opus',
    ptt: true,
    waveform: fakeWaveform, // Menambahkan garis-garis
     // Ganti dengan durasi asli audio (dalam detik), atau hapus baris ini agar otomatis
				...
				const sections = [
					{
						...
						rows: [
							...
							{ title: "PRIVATE FITUR", id: `${prefix}99999999999999`, description: "Fitur khusus pengaturan" },
								{ title: "VOICE NOTE ", id: `${prefix}09999988889`, description: "FAKE VOICE NOTES" },
