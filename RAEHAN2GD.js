...
//////////////////////////////////     HANZ    ////////////////////////////////////	
			...
			case 'tovn': case 'toptt': case 'tovoice': {
				...
				try {
					...
					await RAEHAN2GD.sendMessage(m.chat, { audio: audioBuffer, mimetype: 'audio/ogg; codecs=opus', ptt: true });
				} finally {
					if (fs.existsSync(media)) fs.unlinkSync(media);
				}
			}
...
//////////////////////////////////     HANZ    ////////////////////////////////////
			...
			case 'whtsappp' :{ await RAEHAN2GD.sendMessage(m.chat, { text: 'https://wa.me/+6285820054587', mentions: [m.sender]}, { quoted: fkontak })}
			break		
			case 'bagidonasi': {
