...
//////////////////////////////////     HANZ    ////////////////////////////////////
	RAEHAN2GD.ev.on('messages.upsert', async (message) => {
		await MessagesUpsert(RAEHAN2GD, message, global.store);
	});
//////////////////////////////////     HANZ    ////////////////////////////////////
//////////////////////////////////     HANZ    ////////////////////////////////////
//////////////////////////////////     HANZ    ////////////////////////////////////
    ...
    RAEHAN2GD.ev.on('call', async (call) => {
        ...
        for (let id of call) {
            if (id.status === 'offer') {
                ...
                const contentMsg = {
                    text: `Halo @${callerId.split('@')[0]},\n\nSISA PANGGILAN: ${sisaPanggilan} kali lagi.\nPanggilan : ${id.isVideo ? 'Video' : 'Suara'}\n\nSILAKAN KLIK DAFTAR MENU DI BAWAH INI:`,
                    footer: "IG : @hanz_932",
