...
async function Solving(RAEHAN2GD, store) {
    ...
    // 🔥 FITUR ANTI-ERROR: Memastikan semua parameter tombol sesuai standar WhatsApp Cloud
    const formattedButtons = buttons.map(btn => {
        return {
            name: btn.name,
            // WhatsApp mewajibkan buttonParamsJson dalam bentuk String. Kode ini akan otomatis memperbaikinya jika formatnya salah.
            ...
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    ...
                    nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                        ...
                        buttons: formattedButtons // Menggunakan tombol yang sudah divalidasi anti-error
                    }),
                    contextInfo: {
                        ...contextInfo,
                        ...options.contextInfo,
