            ...
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    ...
                    header: proto.Message.InteractiveMessage.Header.create({
                        title: title || '',
                        subtitle: subtitle || '',
                        hasMediaAttachment: media && Object.keys(media).length > 0,
                    ...
                    nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                        ...
                        // PERBAIKAN: Melewatkan parameter buttons secara langsung tanpa memodifikasi struktur JSON bawaan script kamu
                        buttons: buttons
                    }),
                    contextInfo: {
                        ...contextInfo,
